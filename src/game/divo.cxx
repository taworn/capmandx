...
void Divo::nextMove()
{
	...
	if (count <= 0)
		...
		if ((dirs & Map::MOVE_LEFT) == Map::MOVE_LEFT && opposite != Map::MOVE_LEFT) randoms[end++] = Map::MOVE_LEFT;
		if ((dirs & Map::MOVE_RIGHT) == Map::MOVE_RIGHT && opposite != Map::MOVE_RIGHT) randoms[end++] = Map::MOVE_RIGHT;
		if ((dirs & Map::MOVE_UP) == Map::MOVE_UP && opposite != Map::MOVE_UP) randoms[end++] = Map::MOVE_UP;
		if ((dirs & Map::MOVE_DOWN) == Map::MOVE_DOWN && opposite != Map::MOVE_DOWN) randoms[end++] = Map::MOVE_DOWN;
